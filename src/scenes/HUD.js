...
class HUD extends Phaser.Scene{
    ...
    create() {
        this.cora= this.add.image(1200, 100, 'heart').setScale(.5).setDepth(1);
        this.cora2= this.add.image(1300, 100, 'heart').setScale(.5).setDepth(1);
        this.cora3= this.add.image(1400, 100, 'heart').setScale(.5).setDepth(1);

        let ourGame = this.scene.get('Fisicas');
        this.score = 0;
